...
const RegisterForm = () => {
  ...
  const submitUser = (e) => {
    ...
    axios
      .post(
        "https://anywhere-fitness4.herokuapp.com/api/auth/client_register",
        newUser
      )
      .then((res) => {
        console.log(res);
  ...
  return (
    <div style={{ marginTop: "3%" }}>
      <video
        ...
        loop
        autoPlay
        style={{ width: "100%", height: "95%", padding: "3.0%" }}
      >
      ...
      <Form
        ...
        style={{
          ...
          left: "50%",
          backgroundImage:
            "linear-gradient(to right, rgba(0,0,0,.5), rgba(0,0,0,.5), rgba(0,0,0,.5))",
          padding: "2.61%",
          color: "#f1faee",
      ...
      >
        <FormGroup
          ...
          style={{
            backgroundImage:
              "linear-gradient(to right, rgba(28,9,32,.5), rgba(28,9,32,.5), rgba(28,9,32,.5))",
            padding: "1%",
            boxShadow: "1px 1px 5px black",
          }}
        >
